...
export default function SteepleLapsCalculator() {
    ...
    function handleSplitsByPace() {
        ...
        const url = import.meta.env.VITE_API_URL + `/steeplesplitscalc/bypace?pace=${p}&paceUnit=${pUnit}&pitType=${pitType}`;
    ...
    function handleSplitsByTime() {
        ...
        const url = import.meta.env.VITE_API_URL + `/steeplesplitscalc/bytime?time=${time}&distance=${dist}&distUnit=${distUnit}&pitType=${pitType}`;
