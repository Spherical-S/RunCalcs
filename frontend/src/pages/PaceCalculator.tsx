...
export default function PaceCalculator() {
    ...
    function handleSubmitPaceCalculation() {
        ...
        const url = import.meta.env.VITE_API_URL + `/pacecalc/pace?time=${time}&distance=${dist}&unit=${distUnit}`;
    ...
    function handleSubmitTimeCalculation() {
        ...
        const url = import.meta.env.VITE_API_URL + `/pacecalc/time?distance=${distance}&distUnit=${distUnit}&pace=${p}&paceUnit=${pUnit}`;
    ...
    function handleSubmitDistanceCalculation() {
        ...
        const url = import.meta.env.VITE_API_URL + `/pacecalc/distance?time=${time}&pace=${p}&unit=${pUnit}`;
    ...
    return (
        <>
            <Helmet>
                <title>Running Pace Calculator | RunCalcs</title>
                <meta name="description" content="Calculate your running pace, time, or distance. Enter any two variables and instantly find the third — supports metric and imperial units." />
                <meta name="keywords" content="running pace calculator, pace time distance, calculate running pace, min per km, min per mile, race pace calculator" />
                <link rel="canonical" href="https://runcalcs.ca/pace" />
                <meta property="og:title" content="Running Pace Calculator | RunCalcs" />
                <meta property="og:description" content="Calculate your running pace, time, or distance. Enter any two variables and instantly find the third — supports metric and imperial units." />
                <meta property="og:url" content="https://runcalcs.ca/pace" />
            </Helmet>
