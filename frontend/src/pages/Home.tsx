...
export default function Home() {
    ...
    return (
        <>
            <Helmet>
                <title>RunCalcs | Free Running Calculators</title>
                <meta name="description" content="Free, no sign up, running calculators for pace, splits, World Athletics points, flat/banked track conversions, and more. Built for runners of all levels." />
                <meta name="keywords" content="running calculator, pace calculator, splits calculator, grade adjusted pace, world athletics points, track and field calculator, running tools" />
                <link rel="canonical" href="https://runcalcs.ca/" />
                <meta property="og:title" content="RunCalcs | Free Running Calculators" />
                <meta property="og:description" content="Free, no sign up, running calculators for pace, splits, World Athletics points, flat/banked track conversions, and more. Built for runners of all levels." />
                <meta property="og:url" content="https://runcalcs.ca" />
            </Helmet>
