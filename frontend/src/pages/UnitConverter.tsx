...
export default function UnitConverter() {
    ...
    function handleSubmitPaceCalculation() {
        ...
        const url = import.meta.env.VITE_API_URL + `/unitconversion/pace?pace=${p}&unit=${pUnit}`;
    ...
    function handleSubmitDistanceCalculation() {
        ...
        const url = import.meta.env.VITE_API_URL + `/unitconversion/distance?distance=${dist}&unit=${distUnit}`;
    ...
    return (
        <>
            <Helmet>
                <title>Running Pace & Distance Unit Converter | RunCalcs</title>
                <meta name="description" content="Convert running paces between min/km, min/mi, km/h, and mi/h. Converts distances between kilometres, miles, metres, and yards." />
                <meta name="keywords" content="pace converter, min/km to min/mile, km/h to min/km, running pace units, distance converter, miles to kilometres, metres to yards" />
                <link rel="canonical" href="https://runcalcs.ca/units" />
                <meta property="og:title" content="Running Pace & Distance Unit Converter | RunCalcs" />
                <meta property="og:description" content="Convert running paces between min/km, min/mi, km/h, and mi/h. Converts distances between kilometres, miles, metres, and yards." />
                <meta property="og:url" content="https://runcalcs.ca/units" />
            </Helmet>
