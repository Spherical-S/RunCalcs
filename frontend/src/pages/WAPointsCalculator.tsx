...
export default function WAPointsCalculator() {
    ...
    return (
        <>
            <Helmet>
                <title>World Athletics Points Calculator | RunCalcs</title>
                <meta name="description" content="Convert any World Athletics event performance to WA points, or convert points back to a performance. Covers all official indoor, outdoor, road, and field events." />
                <meta name="keywords" content="world athletics points calculator, WA points, athletics scoring table, track and field points, performance to points, points to performance, indoor outdoor road field events" />
                <link rel="canonical" href="https://runcalcs.ca/wa-points" />
                <meta property="og:title" content="World Athletics Points Calculator | RunCalcs" />
                <meta property="og:description" content="Convert any World Athletics event performance to WA points, or convert points back to a performance. Covers all official indoor, outdoor, road, and field events." />
                <meta property="og:url" content="https://runcalcs.ca/wa-points" />
            </Helmet>
