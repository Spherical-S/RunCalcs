...
export default function SplitsCalculator() {
    ...
    function handleSplitsByTime() {
        ...
        const url = import.meta.env.VITE_API_URL + `/splitscalc/bytime?splitLen=${sdist}&splitUnit=${sDistUnit}&time=${time}&distance=${dist}&distUnit=${distUnit}`;
    ...
    function handleSplitsByPace() {
        ...
        const url = import.meta.env.VITE_API_URL + `/splitscalc/bypace?splitLen=${sdist}&splitUnit=${sDistUnit}&pace=${p}&paceUnit=${pUnit}&distance=${dist}&distUnit=${distUnit}`;
